...
spotifyApi.setAccessToken('BQASAmEwutI0oZ-nsU7yGPtR4XuPtjQ6d0rRybvp0tgC7dkx88tmxzbjKW3nu15faTlisMLlaFHeY5YAwTi-QBTIwLS6OXTJVJJN0B28AuqUes79g35AC9kzKciV-r74a7siWzTLm8RZQ2wZ5HVrQBL34rem-Bw');

spotifyApi.getUserPlaylists('elliedub').then(function (data) {
  // console.log('User playlists', data);
  var playlists = data.items;
  playlists.forEach(function (playlist) {
    console.log(playlist.name, playlist.id);
    spotifyApi.getPlaylistTracks('elliedub', playlist.id).then(function (data) {
